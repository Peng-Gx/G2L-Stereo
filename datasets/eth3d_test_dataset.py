...
class ETH3DTestDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # mask = self.load_mask(os.path.join(self.datapath, self.mask_filenames[index]))
        ...
        if self.training:
            ...
            # assert len(disparity.shape)==2 and len(mask.shape)==2
